...
export const REGISTER_TEXT_FIELDS = [
  ...
  },
  {
    ...
    errorMessage: "Пароль должен быть не менее 8 символов и содержать минимум одну цифру, одну заглавную и одну строчную букву",
  },
  {
    name: "login",
    label: "Логин",
    ...
    errorMessage: "Логин должен содержать только буквы, цифры, символы _.- и быть длиной от 3 до 20 символов"
  },
  {
    name: "phoneNumber",
